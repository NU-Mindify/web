...
import phone1 from "../../assets/landingpage/phone1.webp";
import phone2 from "../../assets/landingpage/phone2.webp";
import Apple from "../../assets/landingpage/Apple.webp";
import Google from "../../assets/landingpage/Google.webp";
import mindify from "../../assets/landingpage/mindify.webp";
import developmental from "../../assets/landingpage/developmental.webp";
import abnormal from "../../assets/landingpage/abnormal.webp";
import industrial from "../../assets/landingpage/industrial.webp";
import psychological from "../../assets/landingpage/psychological.webp";
import general from "../../assets/landingpage/general.webp";
import front from "../../assets/landingpage/front.webp";
import worlds from "../../assets/landingpage/worlds.webp";
import glossary from "../../assets/landingpage/glossary.webp";
import mindmap from "../../assets/landingpage/mindmap.webp";
import mindi from "../../assets/landingpage/mindi.webp";
import shop from "../../assets/landingpage/shop.webp";
import phone4 from "../../assets/landingpage/phone4.webp";
import phone5 from "../../assets/landingpage/phone5.webp";
import phone6 from "../../assets/landingpage/phone6.webp";
...
const LandingPage = () => {
  ...
  const clonedPhones = Array(LOOP_COUNT).fill(phones).flat();
  useEffect(() => {
    ...
    const initialScroll =
      items[startIndex].offsetLeft +
      items[startIndex].offsetWidth / 2 -
  ...
  const faqs = [
    {
      ...
      answer:
        "NU Mindify is a student-focused psychology review app designed to help learners master key concepts and prepare for exams efficiently.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes. NU Mindify is available to students from all NU campuses.",
    },
    {
    ...
    },
    {
      ...
      answer: "No. An active internet connection is required to use the app.",
    },
    {
    ...
    <div className="landing-container">
        ...
        >
          <div className="flex flex-col items-start p-6 space-y-6 text-lg pt-20">
            <a
              ...
              className="w-full border-b border-gray-200 pb-2"
            >
              Home
            </a>
            <a
      ...
      <section id="home" className="hero-section">
        <div className="md:w-1/2 space-y-6 h-full flex flex-col justify-center pl-5">
          ...
          <p>
            Prepare with purpose. Review with confidence. Join{" "}
            <span className="highlight">NU Mindify.</span>
          </p>
        ...
        <div className="image-container relative md:w-1/2 flex justify-center h-[500px]">
          ...
          <img
            src={phone1}
            alt="Phone 1"
            className="phone-image phone1 animate-in-bottom"
            loading="lazy"
          />
          {/* Foreground phone (LCP) */}
          <img
            src={phone2}
            alt="Phone 2"
            className="phone-image phone2 animate-in-top"
            fetchPriority="high"
          />
        </div>
      </section>
      ...
      <section id="about" className="about-nu-section">
        ...
        <p className="text-gray-800 max-w-2xl text-lg pt-2">
          NU Mindify is a modern, student-focused review platform created to
          enhance your learning journey. Prepare smarter, study better, and
        ...
        <div ref={scrollRef} className="phone-scroll-wrapper">
          {clonedPhones.map((phone, index) => {
            ...
            return (
              <div
                key={index}
                className={`phone-item ${isActive ? "active" : ""}`}
              >
        ...
        <div className="download-content">
          ...
          <div className="relative flex justify-center items-end h-[360px] sm:h-[320px] md:h-[400px] lg:h-[460px] mb-10 w-full ">
            ...
            <img
              src={phone5}
              alt="Phone Center"
              className="phone phone-center z-0"
            />
          ...
          <p className="download-description">
            Download NU Mindify now and take the first step toward mastering
            psychology and passing your board exam.
          </p>
