    ...
    return (
        <>
            ...
            <div className="glossary-body">
                <table className="header-details">
                    <tr className="details-holder">
                        <td className="word-header">Terminology</td>
                        <td className="meaning-header">Definition</td>
                        <td className="action-header">Action</td>
                    </tr>
                </table>  
