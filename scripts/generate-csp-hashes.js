...
function updateVercelConfig(scriptHashes, styleHashes) {
  ...
  const scriptSrc = `'self' ${scriptHashes.join(
    " "
  )} https://www.google-analytics.com https://www.googletagmanager.com https://www.gstatic.com https://www.google.com`;
  ...
  const cspValue = `default-src 'self'; 
                    ...
                    img-src 'self' 
                    data: https: https://*.googleapis.com; 
                    connect-src 'self' https://api.numindify.com/api/ https://nu-mindify-api.vercel.app/ https://www.numindify.com/ https://www.google-analytics.com https://vercel.live https://*.googleapis.com; 
